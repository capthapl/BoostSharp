...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BoostSharp.Android.dll" comes first in this list. */
		"BoostSharp.Android.dll",
		"BoostSharp.dll",
		"FormsViewGroup.dll",
		"GoogleGson.dll",
		...
		"Microsoft.AppCenter.Auth.Android.Bindings.dll",
		"Microsoft.AppCenter.Auth.Android.Bindings.Msal.Common.dll",
		"Microsoft.AppCenter.Auth.Android.Bindings.Msal.dll",
		"Microsoft.AppCenter.Auth.dll",
